...
exports.Axios = Axios;
},{"./lib/axios.js":"node_modules/axios/lib/axios.js"}],"create.js":[function(require,module,exports) {
"use strict";
...
function createRecipe() {
  var recipeDetailsDiv = document.getElementById("results");
  ...
  var createDiv = document.getElementById("recipeForm");
  ...
  function _handleSubmit() {
    _handleSubmit = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var title, ingredients, instructions, readyMins, servings, backgroundImg, imageUrl, rawBody, response, recipeData, results, recipeCardItem;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            readyMins = document.getElementById('readyInMinutes').value;
            servings = document.getElementById('servings').value;
            backgroundImg = document.getElementById('background').value;
            ...
            return (0, _axios.default)({
              url: "https://api.spoonacular.com/recipes/visualizeRecipe?apiKey=".concat(API_KEY),
              method: 'POST',
              data: rawBody
            }, {
              headers: {
          ...
          case 27:
            ...
            recipeCardItem = document.createElement('img');
            ...
            return _context.abrupt("return", recipeData);
          case 36:
            _context.prev = 36;
            _context.t0 = _context["catch"](9);
            console.error("Error fetching recipe details:", _context.t0.message);
          case 39:
            _context.next = 42;
            break;
          case 41:
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","create.js"], null)
